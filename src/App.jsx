  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/view" element={<ProtectedRoute><EnvelopeProvider><View /></EnvelopeProvider></ProtectedRoute>} /> 
        ...
        <Route path="/envelope/destinatario" element={<ProtectedRoute><EnvelopeProvider><Destinatario /></EnvelopeProvider></ProtectedRoute>} />
        <Route path="/envelope/sucesso" element={<ProtectedRoute><RecipientSuccess /></ProtectedRoute>} />
        
        {/* 2. Nova rota adicionada */}
        <Route path="/envelope/documento-direto" element={<ProtectedRoute><DirectDocument /></ProtectedRoute>} />
