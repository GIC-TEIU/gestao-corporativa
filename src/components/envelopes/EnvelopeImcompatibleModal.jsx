...
const EnvelopeIncompatibleModal = ({ show, onClose }) => {
  if (!show) return null;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm font-poppins">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-8 text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-3">
          Tipos de Envelopes Incompatíveis
        </h2>

        {/* Texto */}
        <p className="text-gray-600 mb-2">
          Você está tentando agrupar envelopes de tipos diferentes.
        </p>
...
export default EnvelopeIncompatibleModal;
