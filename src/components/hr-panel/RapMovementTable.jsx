                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        {mockData.map((item) => (
                            <tr key={item.id} className="border-b border-[#D9D9D9]">
                                ...
                                <td className="p-2">
                                    <div className="flex justify-center">
                                        <button onClick={() => handleActionClick(item)} className="flex items-center justify-center w-9 h-9 rounded-lg bg-[#4EA64754] border border-[#2F7429] text-[#2F7429] hover:opacity-80 transition">
                                            <Folder size={20} />
                                        </button>
                                    </div>
                                </td>
