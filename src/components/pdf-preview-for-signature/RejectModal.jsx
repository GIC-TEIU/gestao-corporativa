import { Lock, PenTool, Eye, EyeOff, FileText } from 'lucide-react';
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50 font-poppins">
      <div className="bg-white rounded-2xl shadow-lg w-[550px] p-8 relative">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-800">Confirmar Reprovação</h2>
        </div>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="bg-red-600 hover:bg-red-700 disabled:bg-red-500 text-white px-6 py-2 rounded-lg font-medium transition flex items-center gap-2" 
          >
            {isSigning ? (
              <>
